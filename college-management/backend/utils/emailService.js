    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background: #f9f9f9; border-radius: 10px;">
        <div style="background: #8B1A1A; color: white; padding: 20px; border-radius: 10px 10px 0 0; text-align: center;">
          ...
          <p style="margin: 5px 0 0 0;">Late Kalpana Chawla Women's Senior College</p>
        </div>
        <div style="background: white; padding: 30px; border-radius: 0 0 10px 10px;">
          <h2 style="color: #333;">Hello ${userName},</h2>
          <p style="color: #555; font-size: 15px;">Your One-Time Password (OTP) for login verification is:</p>
          <div style="text-align: center; margin: 30px 0;">
            <div style="display: inline-block; background: #fef3c7; border: 2px dashed #f59e0b; padding: 20px 40px; border-radius: 10px;">
              <h1 style="color: #8B1A1A; margin: 0; letter-spacing: 8px; font-size: 36px;">${otp}</h1>
            </div>
          </div>
